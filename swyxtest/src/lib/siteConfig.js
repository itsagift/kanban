...
export const APPROVED_POSTERS_GH_USERNAME = ['itsagift'];
export const GH_USER_REPO = 'itsagift/chase'; // used for pulling github issues and offering comments
export const REPO_URL = 'https://github.com/' + GH_USER_REPO;
export const SITE_TITLE = 'test';
